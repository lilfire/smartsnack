  ...
  container.addEventListener('click', (e) => {
    ...
    switch (action) {
      case 'sort':
        ...
        break;
      case 'toggle-expand': {
        // Don't collapse if clicking inside the edit form (would discard unsaved changes),
        // on buttons, or on other interactive data-action elements
        if (e.target.closest('.edit-form') || e.target.closest('button') || e.target.closest('[data-action]:not([data-action="toggle-expand"])')) return;
