...
def _build_prompt(text: str, target_lang: str) -> str:
    ...
    return (
        ...
        "There must be no words from any other language (Spanish, Italian, "
        "French, English, German, etc.) anywhere in your output.\n"
        ...
        "- Self-check: after writing your response, scan it for any word "
        f"that is not {lang_name}. If found, translate it before returning.\n\n"
        f"Ingredients:\n{text}"
    )
